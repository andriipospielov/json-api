 ...
 */
final class Version20191103183730 extends AbstractMigration
{
...
CREATE TABLE `activity_images_link` 
  ( 
     `id`          INT(11) UNSIGNED NOT NULL auto_increment, 
...
, 
   (
      2, 'Real Madrid VS. Barcelona', 'El Clasico is the term used to refer to football matches between Spain?s most famous and bitterest rivals: FC Barcelona and Real Madrid C.F. The two teams meet twice during a season, with an additional two times in the Copa del Rey, Champions League, and the Supercopa de España, and possibly in the UEFA Super Cup as well. ', 500, 0
   )
, 
   (
